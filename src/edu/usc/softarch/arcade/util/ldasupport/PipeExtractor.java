...
import edu.usc.softarch.arcade.util.WsVulnerabilityAnalyser.Policies;
import edu.usc.softarch.arcade.util.WsVulnerabilityAnalyser.VulnerabilityAnalyser;
...
//		numTopics =99;
		...
		VulnerabilityAnalyser vulnerabilityAnalyser = VulnerabilityAnalyser.getInstance();
...
//		//save for next time
		...
		vulnerabilityAnalyser.applyFilter(Policies.NO_TEST_FILE_POLICY)
				.applyFilter(Policies.SECURED_ENDPOINT_POLICY)
				.applyFilter(Policies.SECURED_SSL_CONFIGURATION_POLICY)
				.detectVulnerabilities()
				.outputResultsTo(outputDir);
	}
